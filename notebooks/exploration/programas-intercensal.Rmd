...
```{r,echo=FALSE,fig.width=25,fig.height=7,message=FALSE, warning=FALSE}
ggplot(estadisticos_prospera_ben_val, aes(x = reorder(as.factor(cdprograma),q2))) +
  geom_boxplot(aes(
      lower = q1,
      upper = q3,
      middle = q2,
...
```{r,echo=FALSE,fig.width=25,fig.height=7,message=FALSE, warning=FALSE}
ggplot(estadisticos_prospera_ben_inval, aes(x = reorder(as.factor(cdprograma),q2))) +
  geom_boxplot(aes(
      lower = q1,
      upper = q3,
      middle = q2,
